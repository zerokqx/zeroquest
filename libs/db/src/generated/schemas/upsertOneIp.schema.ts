...
export const IpUpsertOneSchema: z.ZodType<Prisma.IpUpsertArgs> = z.object({ select: IpSelectObjectSchema.optional(), include: IpIncludeObjectSchema.optional(), where: IpWhereUniqueInputObjectSchema, create: z.union([ IpCreateInputObjectSchema, IpUncheckedCreateInputObjectSchema ]), update: z.union([ IpUpdateInputObjectSchema, IpUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.IpUpsertArgs>;

export const IpUpsertOneZodSchema = z.object({ select: IpSelectObjectSchema.optional(), include: IpIncludeObjectSchema.optional(), where: IpWhereUniqueInputObjectSchema, create: z.union([ IpCreateInputObjectSchema, IpUncheckedCreateInputObjectSchema ]), update: z.union([ IpUpdateInputObjectSchema, IpUncheckedUpdateInputObjectSchema ]) }).strict();