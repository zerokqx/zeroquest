...
export const PlanFindManySelectSchema: z.ZodType<Prisma.PlanSelect> = z.object({
...
export const PlanFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    isSpecial: z.boolean().optional(),
    discountedPercent: z.boolean().optional(),
...
export const PlanFindManySchema: z.ZodType<Prisma.PlanFindManyArgs> = z.object({ select: PlanFindManySelectSchema.optional(), include: z.lazy(() => PlanIncludeObjectSchema.optional()), orderBy: z.union([PlanOrderByWithRelationInputObjectSchema, PlanOrderByWithRelationInputObjectSchema.array()]).optional(), where: PlanWhereInputObjectSchema.optional(), cursor: PlanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PlanScalarFieldEnumSchema, PlanScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PlanFindManyArgs>;

export const PlanFindManyZodSchema = z.object({ select: PlanFindManySelectSchema.optional(), include: z.lazy(() => PlanIncludeObjectSchema.optional()), orderBy: z.union([PlanOrderByWithRelationInputObjectSchema, PlanOrderByWithRelationInputObjectSchema.array()]).optional(), where: PlanWhereInputObjectSchema.optional(), cursor: PlanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PlanScalarFieldEnumSchema, PlanScalarFieldEnumSchema.array()]).optional() }).strict();