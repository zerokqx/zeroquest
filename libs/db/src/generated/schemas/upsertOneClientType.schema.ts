...
export const ClientTypeUpsertOneSchema: z.ZodType<Prisma.ClientTypeUpsertArgs> = z.object({ select: ClientTypeSelectObjectSchema.optional(), include: ClientTypeIncludeObjectSchema.optional(), where: ClientTypeWhereUniqueInputObjectSchema, create: z.union([ ClientTypeCreateInputObjectSchema, ClientTypeUncheckedCreateInputObjectSchema ]), update: z.union([ ClientTypeUpdateInputObjectSchema, ClientTypeUncheckedUpdateInputObjectSchema ]) }).strict() as unknown as z.ZodType<Prisma.ClientTypeUpsertArgs>;

export const ClientTypeUpsertOneZodSchema = z.object({ select: ClientTypeSelectObjectSchema.optional(), include: ClientTypeIncludeObjectSchema.optional(), where: ClientTypeWhereUniqueInputObjectSchema, create: z.union([ ClientTypeCreateInputObjectSchema, ClientTypeUncheckedCreateInputObjectSchema ]), update: z.union([ ClientTypeUpdateInputObjectSchema, ClientTypeUncheckedUpdateInputObjectSchema ]) }).strict();