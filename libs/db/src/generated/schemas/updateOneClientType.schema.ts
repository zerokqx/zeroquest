...
export const ClientTypeUpdateOneSchema: z.ZodType<Prisma.ClientTypeUpdateArgs> = z.object({ select: ClientTypeSelectObjectSchema.optional(),  data: z.union([ClientTypeUpdateInputObjectSchema, ClientTypeUncheckedUpdateInputObjectSchema]), where: ClientTypeWhereUniqueInputObjectSchema }).strict() as unknown as z.ZodType<Prisma.ClientTypeUpdateArgs>;

export const ClientTypeUpdateOneZodSchema = z.object({ select: ClientTypeSelectObjectSchema.optional(),  data: z.union([ClientTypeUpdateInputObjectSchema, ClientTypeUncheckedUpdateInputObjectSchema]), where: ClientTypeWhereUniqueInputObjectSchema }).strict();