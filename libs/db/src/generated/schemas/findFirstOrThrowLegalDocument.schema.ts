...
export const LegalDocumentFindFirstOrThrowSelectSchema: z.ZodType<Prisma.LegalDocumentSelect> = z.object({
...
export const LegalDocumentFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    type: z.boolean().optional(),
    version: z.boolean().optional(),
    content: z.boolean().optional(),
...
export const LegalDocumentFindFirstOrThrowSchema: z.ZodType<Prisma.LegalDocumentFindFirstOrThrowArgs> = z.object({ select: LegalDocumentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => LegalDocumentIncludeObjectSchema.optional()), orderBy: z.union([LegalDocumentOrderByWithRelationInputObjectSchema, LegalDocumentOrderByWithRelationInputObjectSchema.array()]).optional(), where: LegalDocumentWhereInputObjectSchema.optional(), cursor: LegalDocumentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LegalDocumentScalarFieldEnumSchema, LegalDocumentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.LegalDocumentFindFirstOrThrowArgs>;

export const LegalDocumentFindFirstOrThrowZodSchema = z.object({ select: LegalDocumentFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => LegalDocumentIncludeObjectSchema.optional()), orderBy: z.union([LegalDocumentOrderByWithRelationInputObjectSchema, LegalDocumentOrderByWithRelationInputObjectSchema.array()]).optional(), where: LegalDocumentWhereInputObjectSchema.optional(), cursor: LegalDocumentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([LegalDocumentScalarFieldEnumSchema, LegalDocumentScalarFieldEnumSchema.array()]).optional() }).strict();