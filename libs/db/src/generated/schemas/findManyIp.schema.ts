...
export const IpFindManySelectSchema: z.ZodType<Prisma.IpSelect> = z.object({
...
export const IpFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    ip: z.boolean().optional(),
    rangeLow: z.boolean().optional(),
    rangeHigh: z.boolean().optional(),
