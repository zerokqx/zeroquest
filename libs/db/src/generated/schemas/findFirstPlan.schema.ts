...
export const PlanFindFirstSelectSchema: z.ZodType<Prisma.PlanSelect> = z.object({
...
export const PlanFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    name: z.boolean().optional(),
    isSpecial: z.boolean().optional(),
    discountedPercent: z.boolean().optional(),
...
export const PlanFindFirstSchema: z.ZodType<Prisma.PlanFindFirstArgs> = z.object({ select: PlanFindFirstSelectSchema.optional(), include: z.lazy(() => PlanIncludeObjectSchema.optional()), orderBy: z.union([PlanOrderByWithRelationInputObjectSchema, PlanOrderByWithRelationInputObjectSchema.array()]).optional(), where: PlanWhereInputObjectSchema.optional(), cursor: PlanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PlanScalarFieldEnumSchema, PlanScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PlanFindFirstArgs>;

export const PlanFindFirstZodSchema = z.object({ select: PlanFindFirstSelectSchema.optional(), include: z.lazy(() => PlanIncludeObjectSchema.optional()), orderBy: z.union([PlanOrderByWithRelationInputObjectSchema, PlanOrderByWithRelationInputObjectSchema.array()]).optional(), where: PlanWhereInputObjectSchema.optional(), cursor: PlanWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PlanScalarFieldEnumSchema, PlanScalarFieldEnumSchema.array()]).optional() }).strict();