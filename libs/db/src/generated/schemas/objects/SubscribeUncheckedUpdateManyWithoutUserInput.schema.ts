...
const makeSchema = () => z.object({
  ...
  planId: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional(),
  totalGb: z.union([z.number().int(), z.lazy(() => IntFieldUpdateOperationsInputObjectSchema)]).optional()
}).strict();
export const SubscribeUncheckedUpdateManyWithoutUserInputObjectSchema: z.ZodType<Prisma.SubscribeUncheckedUpdateManyWithoutUserInput> = makeSchema() as unknown as z.ZodType<Prisma.SubscribeUncheckedUpdateManyWithoutUserInput>;
export const SubscribeUncheckedUpdateManyWithoutUserInputObjectZodSchema = makeSchema();
