...
export const UserCountOutputTypeCountSubscribesArgsObjectSchema = makeSchema();
export const UserCountOutputTypeCountSubscribesArgsObjectZodSchema = makeSchema();
