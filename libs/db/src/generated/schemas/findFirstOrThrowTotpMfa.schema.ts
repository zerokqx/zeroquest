...
export const TotpMfaFindFirstOrThrowSelectSchema: z.ZodType<Prisma.TotpMfaSelect> = z.object({
...
export const TotpMfaFindFirstOrThrowSelectZodSchema = z.object({
    id: z.boolean().optional(),
    enabled: z.boolean().optional(),
    ciphertext: z.boolean().optional(),
    iv: z.boolean().optional(),
...
export const TotpMfaFindFirstOrThrowSchema: z.ZodType<Prisma.TotpMfaFindFirstOrThrowArgs> = z.object({ select: TotpMfaFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TotpMfaIncludeObjectSchema.optional()), orderBy: z.union([TotpMfaOrderByWithRelationInputObjectSchema, TotpMfaOrderByWithRelationInputObjectSchema.array()]).optional(), where: TotpMfaWhereInputObjectSchema.optional(), cursor: TotpMfaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TotpMfaScalarFieldEnumSchema, TotpMfaScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.TotpMfaFindFirstOrThrowArgs>;

export const TotpMfaFindFirstOrThrowZodSchema = z.object({ select: TotpMfaFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => TotpMfaIncludeObjectSchema.optional()), orderBy: z.union([TotpMfaOrderByWithRelationInputObjectSchema, TotpMfaOrderByWithRelationInputObjectSchema.array()]).optional(), where: TotpMfaWhereInputObjectSchema.optional(), cursor: TotpMfaWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([TotpMfaScalarFieldEnumSchema, TotpMfaScalarFieldEnumSchema.array()]).optional() }).strict();