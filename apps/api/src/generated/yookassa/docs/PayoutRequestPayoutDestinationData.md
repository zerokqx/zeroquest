...
**account_number** | [**PayoutToYooMoneyDestinationDataAllOfAccountNumber**](PayoutToYooMoneyDestinationDataAllOfAccountNumber.md) |  | [default to undefined]
**card** | [**CardDataForPayoutDestination**](CardDataForPayoutDestination.md) |  | [default to undefined]
...
```typescript
import { PayoutRequestPayoutDestinationData } from 'yookassa-client';

const instance: PayoutRequestPayoutDestinationData = {
    type,
    account_number,
    card,
    phone,
